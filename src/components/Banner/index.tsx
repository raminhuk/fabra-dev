    ...
    return <>
        <div className="flex h-screen w-full items-center max-lg:h-[calc(100vh-72px)] max-lg:min-h-[620px] max-lg:items-start">
            <div className="container">
                <div className="group relative w-full pt-20 max-lg:mb-20 max-lg:pt-6">
                    <div className="relative z-40 flex flex-col gap-10 max-lg:my-10 max-lg:gap-5">
                        ...
                        <div className="flex max-lg:hidden">
                            <Link href="/" onClick={() => sendGTMEvent({ event: 'download_cv', value: 'Download CV' })} className="rounded-full bg-blue-500 bg-gradient-custom px-8 py-4 text-sm shadow-lg shadow-blue-500/50">Download CV</Link>
                        </div>
                    </div>
